...
<html lang="vi">
  <head>
    ...
    <!-- Custom styles-->
    <link href="{{ url('public/admin/dist/css/signin.css') }}" rel="stylesheet">

    <!-- Bootstrap Core CSS -->
    <link href="{{ url('public/admin/bower_components/bootstrap/dist/css/bootstrap.min.css') }}" rel="stylesheet">

    <script src="{{ url('public/admin/assets/js/jquery-1.10.2.min.js') }}"></script>
     ...
     @endif
        <div class="panel panel-info" >
            ...
            <div style="padding-top:30px" class="panel-body" >
                ...
                <form id="loginform" class="form-horizontal" method="POST" action="{{ route('postlogin') }}" role="form">
