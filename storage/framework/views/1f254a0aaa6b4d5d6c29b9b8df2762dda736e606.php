<?php $__env->startSection('content'); ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><small>Sửa </small> Thông tin tài khoản <i style="color: red"><?php echo $data->username; ?></i>
                        </h1>
                    </div>
                    <!-- /.col-lg-7 -->
                    ...
                    <?php echo $__env->make('admin.blocks.error', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        ...
                        <?php endif; ?>
                        <form action="<?php echo URL::route('admin.postInfo',$data->id); ?>" method="POST">
