    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo URL::route('admin.home'); ?>">Admin Area</a>
            </div>
            <!-- /.navbar-header -->
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo URL::route('user.home'); ?>">Member</a></li>
                </ul>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            ?>
                            <li><a href="<?php echo URL::route('admin.getInfo',$data->id); ?>"><i class="fa fa-user fa-fw"></i>Thông tin tài khoản</a>
                            </li>
                            <!--<li><a href="#"><i class="fa fa-gear fa-fw"></i> Cài đặt</a></li>-->
                            <li class="divider"></li>
                            <li><a href="<?php echo URL::route('logout'); ?>"><i class="fa fa-sign-out fa-fw"></i> Đăng xuất</a>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::route('admin.list'); ?>">Danh sách người dùng</a>
                                </li>
                                <li>
                                    <a href="<?php echo URL::route('admin.getAdd'); ?>">Thêm người dùng</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
